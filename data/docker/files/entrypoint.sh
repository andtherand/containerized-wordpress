...
if [ -f $first_run ]; then
  ...
  cp /app-temp/.env /app/.env
  cp /app-temp/.editorconfig /app/.editorconfig
  cp /app-temp/composer.json /app/composer.json
  cp /app-temp/wp-cli.yml /app/wp-cli.yml
  cp /app-temp/main-config.php /app/main-config.php
  cp /app-temp/index.php /app/public/index.php
  cp /app-temp/wp-config.php /app/public/wp-config.php
